...
interface WebhookEnvelope {
  ...
  data:
    | {
        ...
        refund?: {                      // trade.refunded — per refunded item, USD
          itemId: string;               // matches TradeItem.id
          externalId?: string;          // your own per-item ref, when you supplied one
          buyerFault: boolean;
          refunded: number;             // returned to the wallet (sourcing + fee)
